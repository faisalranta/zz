				...
				<div class="row">
					...
					<div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
						<div class="well">
							...
							<div class="row">
								<?php echo Form::open(array('url' => 'fad/addCashPaymentVoucherDetail?m='.$m.'','id'=>'cashPaymentVoucherForm'));?>
												...
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
													<div class="row">
														...
														<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
															...
															<input type="date" class="form-control requiredField" max="<?php echo date('Y-m-d') ?>" name="pv_date_1" id="pv_date_1" value="<?php echo date('Y-m-d') ?>" />
														</div>
													</div>	
												</div>
												<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																	...
																	<table id="buildyourform" class="table table-bordered">
																		...
																		<tbody class="addMorePvsDetailRows_1" id="addMorePvsDetailRows_1">
																			...
																			<tr>
																				...
																				<td>
																					<input onfocus="mainDisable('c_amount_1_<?php echo $j ?>','d_amount_1_<?php echo $j ?>');" placeholder="Debit" class="form-control d_amount_1 requiredField" maxlength="15" min="0" type="number" name="d_amount_1_<?php echo $j ?>" id="d_amount_1_<?php echo $j ?>" onkeyup="sum('1')" value="" required="required"/>
																				</td>
																				<td>
																					<input onfocus="mainDisable('d_amount_1_<?php echo $j ?>','c_amount_1_<?php echo $j ?>');" placeholder="Credit" class="form-control c_amount_1 requiredField" maxlength="15" min="0" type="number" name="c_amount_1_<?php echo $j ?>" id="c_amount_1_<?php echo $j ?>" onkeyup="sum('1')" value="" required="required"/>
																				</td>
