			...
			<div class="row">
				<?php 
					if($rvsDetail->rv_status == 1){
						echo Form::open(array('url' => 'fad/editBankReceiptPendingVoucherDetail?m='.$m.'','id'=>'bankReceiptVoucherForm'));
				}else if($rvsDetail->rv_status == 2){
					echo Form::open(array('url' => 'fad/editBankReceiptApproveVoucherDetail?m='.$m.'','id'=>'bankReceiptVoucherForm'));
				}
				?>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
									...
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											...
											<input type="text" class="form-control requiredField" placeholder="Cheque No" name="cheque_no" id="cheque_no" value="<?php echo $rvsDetail->cheque_no?>" />
										</div>
										<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
											<label class="sf-label">Cheque Date.</label>
											<span style="font-size:17px !important; color:#F5F5F5 !important;"><strong>*</strong></span>
											<input type="date" class="form-control requiredField" max="<?php echo date('Y-m-d') ?>" name="cheque_date" id="cheque_date" value="<?php echo $rvsDetail->cheque_date?>" />
										</div>
									</div>	
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
...
<script>
	...
	function formSubmitOne(e){
		...
		var postData = $('#bankReceiptVoucherForm').serializeArray();
		var formURL = $('#bankReceiptVoucherForm').attr("action");
		$.ajax({
        	url : formURL,
            type: "POST",
            data : postData,
